...
### 2.5 Se connecter à l'environnement et télécharger les métadonnées
...
**Étape 6.** Une solution vous est demandée. **Ne choisissez pas la solution `Default`** (Par défaut). Sélectionnez celle créée spécifiquement pour votre environnement Finance and Operations lors de son provisionnement.
...
### 2.6 Vérifier la configuration des métadonnées
...
| `Application version to restore cross reference database from` (Version d'application source) | La version téléchargée en 2.5 |
...
### 2.7 Checklist de validation de la phase 1
...
- [ ] La connexion à l'environnement aboutit, sur la bonne solution.
...
| [ ] | **Se connecter avec l'`Environment URL`, et non l'adresse de l'application** | `System administrator` | 2.5 |
| [ ] | **Sélectionner la solution de l'environnement, et non `Default`** | `System administrator` | 2.5 |
| [ ] | Télécharger les métadonnées de référence | `System administrator` | 2.5 |
| [ ] | Installer l'extension Finance and Operations | Administrateur local | 2.5 |
| [ ] | Vérifier les 24 Go du dossier des assets | Aucun | 2.5 |
| [ ] | Vérifier l'ouverture de l'`Application Explorer` | Aucun | 2.6 |
...
| :-- | :-- | :-- |
| Préfixe d'éditeur | Trois lettres, appliquées à tout objet créé | `Arc` pour ARCHIA365 |
